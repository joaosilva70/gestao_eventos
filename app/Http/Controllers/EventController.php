...
class EventController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $event->city = $request->eventLocation;
        $event->private = $request->eventPrivate;
        $event->items = $request->items;

        //Image Upload
        if($request->hasFile('eventImage') && $request->file('eventImage')->isValid()) {

            $requestImage = $request->eventImage;
    ...
    public function destroy($id) {
        ...
        return redirect('/dashboard')->with('msg', 'The event has been successfully deleted.');
    }
    ...
    public function update(Request $request) {
        ...
        return redirect('/dashboard')->with('msg', 'The event has been successfully edited.');
    }
